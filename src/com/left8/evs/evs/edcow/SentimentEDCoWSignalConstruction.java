 ...
 */
public class SentimentEDCoWSignalConstruction {
    ...
    public void firstSignalConstruction(double[] nwt, double [] nt){
        ...
        SentimentEDCoWVector ni = new SentimentEDCoWVector(nt);
        SentimentEDCoWVector nwi = new SentimentEDCoWVector(nwt);
    ...
    public void secondSignalConstruction(double[] sw, int delta, int level){		
        ...
        for (int i = 0, k = 0; i < sw2.length * delta; i = i + delta, k++){
            ...
            SentimentEDCoWDwt dwtDtPrime = new SentimentEDCoWDwt(signDtPrime,level);
            SentimentEDCoWDwt dwtDtStar = new SentimentEDCoWDwt(signDtStar,level);
            dwtDtPrime.hMeasure();
            dwtDtStar.hMeasure();
