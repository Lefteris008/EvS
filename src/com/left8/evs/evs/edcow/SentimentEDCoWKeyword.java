...
////////////////////////////////////////////////////////////////////////////////
/**
 * @author yue HE, Falitokiniaina RABEARISON, Département Informatique et
 * Statistiques, Université Lumière Lyon 2
 * @author Adrien GUILLE, Laboratoire ERIC, Université Lumière Lyon 2
 */
public class SentimentEDCoWKeyword {
    ...
    public SentimentEDCoWKeyword(String keyword_, double[] nwt_, int delta_, double[] distribution) {
        nwt = nwt_;
        delta = delta_;
        nt = distribution;
        keyWord = keyword_;
    ...
    public final void computations() {
        ...
        SentimentEDCoWSignalConstruction signWavelet = new SentimentEDCoWSignalConstruction();
        ...
        SentimentEDCoWCrossCorrelationZeroTime cc = new SentimentEDCoWCrossCorrelationZeroTime();
        autoCorrelation = cc.autoCorrelationZeroTime(SW2);
    }

    public void computeCrossCorrelation(LinkedList<SentimentEDCoWKeyword> keyWordsList1) {
    ...
    public void getCorrelations(double[] frequency, LinkedList<SentimentEDCoWKeyword> keyWordsList) {
        nwt = frequency;
        computations();
