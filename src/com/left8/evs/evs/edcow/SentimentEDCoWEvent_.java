 ...
 */
public class SentimentEDCoWEvent_ implements Comparable<SentimentEDCoWEvent_>{
    public LinkedList<String> keywords;
    public double epsylon;
    public float startSlice;
    public float endSlice;
    
    public SentimentEDCoWEvent_(LinkedList<String> keywords_, float startDay_, float endDay_){
        keywords = keywords_;
        startSlice = startDay_;
        endSlice = endDay_;
    }
    
    public SentimentEDCoWEvent_(){
    ...
    @Override
    public int compareTo(SentimentEDCoWEvent_ event0) {
